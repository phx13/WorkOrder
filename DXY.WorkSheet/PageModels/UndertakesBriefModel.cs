...
namespace DXY.WorkSheet.PageModels
{
    ...
    /// 承接人统计- 简略
    /// </summary>
    public class UndertakesBriefModel : PageModel
    {
        /// <summary>
        /// 当前所有数据
        /// </summary>
        ...
        public override void InitPage(string pageName)
        {
            ...
            base.PageControl.Gantt.Controller.ShowContentType1 = "显示内容：项目数/平均计划人日/平均实际人日";
            base.PageControl.Gantt.Controller.ShowContentType2 = "浮窗内容：项目/事项";
